$(function() {
    ...
    $.ajax({
        type: 'get',
        url: 'http://127.0.0.1:8000/admin/general-company/get-projects/ajax'
    }).done(function(datas) {
        for(const deleteBtn of deleteBtnList){
            ...
            if(inactiveLine.length > 0){
                ...
                let tooltipStr = 'Suppression impossible car l\'entreprise générale est utilisé dans les projest suivants:\n '
